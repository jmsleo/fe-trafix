          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none text-[#BF8F51]">
                  ...
                  <select
                    ...
                    className="w-full h-[52px] pl-12 pr-10 bg-[#16120E] border border-[#BF8F51]/40 rounded-[12px] text-[#BF8F51] text-[20px] focus:outline-none focus:border-[#BF8F51] transition-all appearance-none cursor-pointer"
                  >

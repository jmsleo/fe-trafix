...
export default function MonitoringManlessPage() {
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
        <h1 className="text-3xl font-bold text-[#EAE1D8]">Monitoring Device Manless</h1>
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center p-4 rounded-[10px] border border-[#B5884D]/50 bg-transparent w-full gap-4">
        <p className="text-sm text-gray-400">
          Total {items.length} device controller manless.
        </p>
        <div className="relative w-full lg:w-[280px]">
          ...
          <input
            ...
            placeholder="Cari Device Manless..."
      ...
      <DeviceMonitorTable
        ...
        isError={isError}
        onRetry={() => refetch()}
        emptyText="Belum ada device manless."
      />
    </div>
  );
}
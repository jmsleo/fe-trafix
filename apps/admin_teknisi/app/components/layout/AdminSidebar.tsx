...
export default function AdminSidebar() {
  ...
  const adminMenus = [
    ...
    { 
      ...
      // Ikon Papan Plang Gantung (Sesuai Desain)
    ...
    { 
      ...
      // Ikon Cloud Upload (Panah ke Atas)
    ...
    { 
      ...
      // Ikon History / Rotate (Panah Melingkar)
    ...
    { 
      ...
      // Ikon File Search (Dokumen dengan Kaca Pembesar)
  ...
  return (
    <aside className="w-[253px] ml-[20px] pt-[40px] flex flex-col shrink-0 min-h-screen">
      ...
      <div className="flex items-center gap-3.5 pl-4 mb-8">
        <Image 
          src="/image/logo-fp.svg" // Sesuaikan dengan nama logo SVG/PNG yang kamu export tadi
          alt="Logo Fix Parking"
          width={36} // Ukuran sudah saya besarkan sedikit agar proporsional
          height={36}
          className="shrink-0"
        />
